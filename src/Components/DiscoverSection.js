...
import styles from "./styles/DiscoverSectionStyles";
                ...
                <div>
                  <li className="py-2">
                    <div className="list-box media">
                      ...
                      <span className="media-body pl-2">
                        Morbi laoreet, tortor fermentum rhoncus commodo, justo
                        odio ultrices.{" "}
                      </span>
                    </div>
                  </li>
                  ...
                  <li className="py-2">
                    <div className="list-box media">
                      ...
                      <span className="media-body pl-2">
                        Suspendisse commodo arcu eget purus fermentum, et
                        mollis.
                      </span>
                    </div>
                  </li>
                  <li className="py-2">
                    <div className="list-box media">
                      ...
                      <span className="media-body pl-2">
                        Pellentesque sed metus auctor, rutrum diam sit amet,
                        tempus ante. Pellentesque pulvinar.
                      </span>
                    </div>
                  </li>
                </div>
