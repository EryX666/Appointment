...
import styles from "./styles/HeadingSectionStyles.js";
					...
					<div className="col-12 col-md-7">
						<div className={classes.HeadingParagraphContainer}>
							...
							<p className="my-4">
								...
								adipisicing elit. Temporibus commodi, voluptate
								quaerat iure quidem expedita eos a blanditiis
								sint modi est error veniam facere eum at
