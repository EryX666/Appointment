...
import styles from "./styles/InstructionsSection.js";

function InstructionsSection(props) {
	const { classes } = props;
	return (
		<section
			className={classes.InstructionsSection}
					...
					<div className="col-12 col-md-4">
						<div className={classes.SingleWork}>
							...
							<p className="text-white">
								Lorem Ipsum dolor sit amet, consectetur
								adipisicing elit. Eius saepe, volptates quis
								enim incidunt obcaecati
							</p>
